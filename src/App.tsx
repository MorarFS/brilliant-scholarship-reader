...
function PaperCard({ paper, saved, annotationCount, onToggleSaved, onOpenReader }: { paper: Paper; saved: boolean; annotationCount: number; onToggleSaved: (paper: Paper) => void; onOpenReader: (paper: Paper) => void }) {
